...
from perfect_actions import PerfectAction
pbar = ProgressBar()
...
def main():
    ...
    per_act = PerfectAction(ask_train, bid_train)
    pnl, prof, actions = per_act.bestSafeAction()
    print pnl, prof
    print (actions == 1).sum(), (actions == 2).sum(), (actions == 0).sum()
    '''
    ## Reshape the date
    ...
    plt.savefig('btrcnn_output/convrg_rst.png')
    
    ## show model configuration
    plot_model(model, to_file = 'btrcnn_output/model.png')
    '''
